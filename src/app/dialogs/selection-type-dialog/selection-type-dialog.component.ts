...
@Component({
  selector: 'app-selection-type-dialog',
  templateUrl: './selection-type-dialog.component.html',
  styleUrls: ['./selection-type-dialog.component.scss'],
})
export class SelectionTypeDialogComponent implements OnInit {
  countries = [
    {
      name: 'Afghanistan',
      dialCode: '+93',
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<SelectionTypeDialogComponent>
  ) {
    switch (data.type) {
      case 'gender':
        this.form = fb.group({
        ...
        this.form = fb.group({
          nationality: [
            data.profile.nationality
              ? this.getCountryCode(data.profile.nationality)
              : '',
            [Validators.required],
          ],
        });
      ...
      case 'marital_status':
        this.form = fb.group({
          marital_status: [
            data.profile.marital_status ? data.profile.marital_status : '',
            [Validators.required],
          ],
        });
